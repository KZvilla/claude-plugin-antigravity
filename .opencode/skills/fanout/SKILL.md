...
ninguna señal intermedia. En Claude Code, con `/lagrange/setup` (track E) se
puede activar una línea de progreso en la statusline (`🔀 fanout <slug>: 3/5 ok
· 1 reintentando(429) · 1 corriendo`) mientras corre. En opencode usá
`/lagrange/watch` para seguir el lote en el navegador.
